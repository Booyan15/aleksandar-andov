    ...
    <form ref={formRef} action={formAction} className="space-y-5" noValidate>
      ...
      <div>
        ...
        <input
          ...
          placeholder="Краток предмет на прашањето"
      ...
      <div>
        ...
        <textarea
          id="question-message"
          name="message"
          className={`${inputClass(Boolean(state.errors?.message))} min-h-36 resize-y`}
      ...
      <div>
        <label
          className={`flex items-start gap-3 rounded-md border bg-municipal-yellow/15 p-4 text-sm leading-6 text-municipal-text ${
            state.errors?.consent ? "border-red-500" : "border-municipal-gold/45"
          }`}
        >
          <input
            name="consent"
            type="checkbox"
            className="mt-1 h-4 w-4 rounded border-municipal-line text-municipal-red focus:ring-municipal-red"
