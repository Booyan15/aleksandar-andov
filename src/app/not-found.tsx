...
export default function NotFound() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-municipal-warm px-4">
      <div className="max-w-lg rounded-lg border border-municipal-line border-t-4 border-t-municipal-red bg-white p-8 text-center shadow-official">
        ...
        <p className="mt-4 text-municipal-text/75">
